...
var persisters = (function () {
	...
	var BattlePersister = Class.create({
		...
		move: function (unit, gameId, success, error) {
		    var moveData = {
		        unitId: unit.id,
		...
		attack: function (unit, gameId, success, error) {
		    var attackData = {
		        unitId: unit.id,
		        position: unit.position
		    };
		...
		defend: function (unit, gameId, success, error) {
		    var url = this.rootUrl + gameId + "/defend/" + sessionKey;
		    httpRequester.postJSON(url, unit.id, success, error);
		}
	});
